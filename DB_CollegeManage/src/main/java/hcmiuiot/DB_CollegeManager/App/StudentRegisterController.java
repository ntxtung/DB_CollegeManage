...
public class StudentRegisterController implements Initializable {
    ...
    void onBrowseIMG(ActionEvent event) {
    	...
    	fileChooser.getExtensionFilters().addAll(
    		    new FileChooser.ExtensionFilter("Image", "*.jpg;*.bmp;*.png"));
    ...
    void onCreate(ActionEvent event) {
    	PreparedStatement st = DbHandler.getInstance().getPreparedStatement("INSERT INTO Student(studentID, fName, lName, birthday, password, img, deptID) VALUES "
    																								+ "(?,?,?,?,?,?,?)");
    	try {
